...
list_remove v (h::t) = ite (eql v h) t (list_remove v t)
...
combine (h::t) l2 = ite (member h l2) (h::(combine t l2)) (combine t l2)
...
list_difference (h::t) l2 = ite (member h l2) (list_remove h l2) (list_difference t l2)
...
--takes element h and list b and returns list of all pairs (h,e)
--where e is an element of list b
pairelt: a -> list b -> list (pair a b)
pairelt someA nil = nil
pairelt someA (b::tb) = (mkPair someA b)::(pairelt someA tb)

--given a list of a and a list of b return list of all ab pairs
...
-- we already did.
set_eql (mkSet l1) (mkSet l2) = same_element l1 l2
-------------------------------------
